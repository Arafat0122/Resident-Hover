...
const Trasted = () => {
    ...
    return (
        <div>
            <div className='mt-10'>
                <h2 className='text-center text-3xl font font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-[#9dca34] to-[#025742] hover:scale-125 hover:text-blue-500'>Our Current Status</h2>
            </div>
            <section className="p-6 my-6 bg-gray-100 text-gray-800">
                <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                    <div data-aos="fade-down-right" className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-zinc-300 text-gray-800">
                    ...
                    <div data-aos="fade-down-left" className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-zinc-300 text-gray-800">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-violet-600">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 text-gray-100">
